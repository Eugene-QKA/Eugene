...
<body>
    ...
    <?php include 'includes/navBar.php'; ?>
        <div class="hero-section">
            ...
            <p>Trash2Tech Management is dedicated to transforming e-waste into sustainable solutions through secure disposal, certified recycling, and hassle-free collection—empowering a greener future, one device at a time.</p>
        </div>
        </div>
